  ...
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm",
  {
    variants: {
      variant: {
        ...
        outline:
          "bg-background shadow hover:bg-sidebar-accent hover:text-sidebar-accent-foreground",
      },
      size: {
        default: "h-8 text-sm",
        sm: "h-7 text-xs",
...
function SidebarMenuAction({ className, ...props }) {
  return (
    <button
      ...
      className={cn(
        "text-sidebar-foreground ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground absolute top-1.5 right-1 flex aspect-square w-5 items-center justify-center rounded-md p-0",
        className
      )}
      {...props}
    />
...
function SidebarMenuBadge({ className, ...props }) {
  return (
    <div
      ...
      className={cn(
        "text-sidebar-foreground absolute right-1 flex h-5 min-w-5 items-center justify-center rounded-md px-1 text-xs font-medium",
        className
      )}
      {...props}
    />
...
function SidebarMenuSubButton({
  ...
  return (
    <Comp
      ...
      data-active={isActive}
      className={cn(
        "text-sidebar-foreground flex items-center gap-2 rounded-md px-2",
