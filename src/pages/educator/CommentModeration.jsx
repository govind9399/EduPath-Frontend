      ...
      <div className="flex w-full">
        ...
        <main className="flex-1 p-6 space-y-6 pb-36">
          <div className="flex justify-between items-center">
            ...
            <button className="border px-4 py-2 rounded-md bg-white">⬅ Back to Dashboard</button>
          </div>
          ...
          <div className="grid grid-cols-4 gap-4">
            ...
            <div className="border-2 border-blue-400 rounded-lg shadow-sm p-4">
          ...
          {/* Filter */}
          <div className="border rounded-lg p-4 flex items-center space-x-3 shadow-none">
            <span>🔍</span>
            <input
