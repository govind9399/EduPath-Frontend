          ...
          <table className="w-full">
            <thead className="bg-gray-50 border-b">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-sm">Stats</th>
                <th className="px-6 py-3 text-left text-sm">Violations</th>
                    ...
                    {user.type === 'creator' ? (
                      <div>
                        ...
                        <div className="text-xs text-gray-500">
                          {user.subscribers.toLocaleString()} subs
                        </div>
                      </div>
                    ) : (
          ...
          <div className="bg-white rounded-lg max-w-2xl w-full p-6">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-gray-900">{selectedUser.type}</p>
              </div>
              <div>
            ...
            {canPerformActions ? (
              <div className="flex gap-3 pt-4 border-t">
                ...
                {selectedUser.type === 'student' && (
                  ...
                  >
                    <Shield className="w-4 h-4" /> Make Creator
                  </button>
                )}
