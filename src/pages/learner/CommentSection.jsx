  ...
  const comments = [
    {
      ...
      time: "2 hours ago",
      text:
        "This is an excellent explanation! I finally understand how React hooks work. The way you broke down the useState and useEffect was really clear. Thank you for taking the time to explain this so thoroughly.",
      likes: 245,
      dislikes: 2,
      replies: 1
    },
    {
      ...
      time: "4 hours ago",
      text:
        "Could you provide more examples on custom hooks? I’m struggling to understand how to create and use them in my projects.",
      likes: 156,
      dislikes: 1,
      replies: 2
    },
    {
      ...
      time: "6 hours ago",
      text:
        "The code examples were really helpful! I've been trying to implement this in my project and it's working perfectly now. Much appreciated!",
      likes: 198,
      dislikes: 0,
      replies: 0
    },
    {
      ...
      time: "8 hours ago",
      text:
        "I have a question about the useEffect cleanup function. How does it work exactly? When does it get called?",
      likes: 87,
      dislikes: 0,
      replies: 1
    },
    {
      ...
      time: "10 hours ago",
      text:
        "This course is amazing! I've learned more in this video than I did in my entire semester at university. Keep up the great work!",
      likes: 312,
      dislikes: 1,
      replies: 0
    },
    {
      ...
      time: "12 hours ago",
      text:
        "Could you explain the difference between useState and useReducer? When should I use one over the other?",
      likes: 143,
      dislikes: 0,
      replies: 0
    },
    {
      ...
      time: "14 hours ago",
      text:
        "The performance optimization tips at the end were really valuable. I've already applied them to my project and noticed a significant improvement!",
      likes: 267,
      dislikes: 0,
      replies: 1
    },
    {
      ...
      time: "16 hours ago",
      text:
        "I'm new to React and this video was perfect for beginners. The pace was just right and the explanations were easy to follow. Subscribed!",
      likes: 189,
      dislikes: 0,
      replies: 0
    }
    ...
    <div className="w-full min-h-screen bg-white text-[#111] font-sans flex flex-col pb-20">
      ...
      <header className="w-full flex items-center justify-between px-6 py-4 border-b bg-white">
        ...
        <div className="flex items-center space-x-4">
          <Button className="bg-[#0038FF] text-white">Creator Studio</Button>
      ...
      <main className="w-[60%] mx-auto p-6 space-y-6">
        <div className="flex justify-between items-center">
          ...
          <Button variant="outline">⬅ Back to Video</Button>
        </div>
        ...
        <Card className="shadow-sm border">
          <CardContent className="p-4 space-y-4">
            ...
            <div className="flex justify-end space-x-3">
              ...
              <Button className="bg-[#0038FF] text-white">📨 Post Comment</Button>
            </div>
          </CardContent>
        </Card>
          ...
          {comments.map((c, i) => (
            <div key={i} className="flex space-x-4">
              ...
              <div className="flex-1">
                <p className="font-semibold">{c.name} <span className="text-xs text-gray-500 ml-2">{c.time}</span></p>
